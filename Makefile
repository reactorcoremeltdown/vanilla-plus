...
app: icons
	...
	git log --name-status -1 HEAD | grep -o 'orig/' && podman run -it -v $(shell pwd):/project -v /tmp/gradlecache:"/root/.gradle" mingc/android-build-box bash -c 'cd /project; ./gradlew build'
