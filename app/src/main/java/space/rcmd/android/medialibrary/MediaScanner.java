...
package space.rcmd.android.medialibrary;

import space.rcmd.android.vanillaplus.R;
import space.rcmd.android.vanillaplus.NotificationHelper;
...
public class MediaScanner implements Handler.Callback {
	...
	MediaScanner(Context context, MediaLibraryBackend backend) {
		...
		mWakeLock = ((PowerManager)context.getSystemService(Context.POWER_SERVICE)).newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "VanillaPlus:Indexer");
