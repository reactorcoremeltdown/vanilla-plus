...
public class PluginUtils {
    ...
    public static final String ACTION_REQUEST_PLUGIN_PARAMS = "space.rcmd.android.vanillaplus.action.REQUEST_PLUGIN_PARAMS"; // broadcast
    public static final String ACTION_HANDLE_PLUGIN_PARAMS = "space.rcmd.android.vanillaplus.action.HANDLE_PLUGIN_PARAMS"; // answer
    public static final String ACTION_LAUNCH_PLUGIN = "space.rcmd.android.vanillaplus.action.LAUNCH_PLUGIN"; // targeted at selected by user

    // these are used by plugins to describe themselves
    public static final String EXTRA_PARAM_PLUGIN_NAME = "space.rcmd.android.vanillaplus.extra.PLUGIN_NAME";
    public static final String EXTRA_PARAM_PLUGIN_APP = "space.rcmd.android.vanillaplus.extra.PLUGIN_APP";
    public static final String EXTRA_PARAM_PLUGIN_DESC = "space.rcmd.android.vanillaplus.extra.PLUGIN_DESC";

    // this is passed to plugin when it is selected by user
    public static final String EXTRA_PARAM_URI = "space.rcmd.android.vanillaplus.extra.URI";
    public static final String EXTRA_PARAM_SONG_TITLE = "space.rcmd.android.vanillaplus.extra.SONG_TITLE";
    public static final String EXTRA_PARAM_SONG_ALBUM = "space.rcmd.android.vanillaplus.extra.SONG_ALBUM";
    public static final String EXTRA_PARAM_SONG_ARTIST = "space.rcmd.android.vanillaplus.extra.SONG_ARTIST";

    static final String EXTRA_PLUGIN_MAP = "space.rcmd.android.vanillaplus.internal.extra.PLUGIN_MAP";
