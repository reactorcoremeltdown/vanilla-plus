...
public class VanillaTabLayout extends SlidingTabLayout {
	...
	public VanillaTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setSelectedIndicatorColors(context.getResources().getColor(space.rcmd.android.vanillaplus.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		view.setTextColor(getResources().getColorStateList(space.rcmd.android.vanillaplus.R.color.tab_text_selector));
		view.setBackgroundResource(space.rcmd.android.vanillaplus.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
